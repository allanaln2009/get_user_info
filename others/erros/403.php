  ...
  <body class="sign error-page-wrapper background-color background-image">
	...
	<div class="pane">
		...
		<div class="context sign-text-color">
			Oops, it seems that the administrator<br>
			has disabled this site :(
		</div>
	</div>
</div>
<div class="text-container">
	...
	<div class="context primary-text-color">
		<p>
			Sorry, this site is unavailable.<br>
			If you think something is broken, report a problem.
		</p>
	</div>
	<div class="buttons-container">
		<a class="border-button" href="http://algumdominio.webege.com/" target="_blank"><span class="fa fa-home"></span> Home Page</a>
